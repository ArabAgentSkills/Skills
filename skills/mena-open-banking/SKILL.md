...
- Classify the request as account information, payments, consent, sandbox, webhook, or compliance.
- Read official provider or regulator references.
- Separate implementation advice from regulated approval requirements.
- Return security and data-retention checks.
