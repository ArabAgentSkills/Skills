...
- `skills/mena-open-banking/sources.yml`
- `skills/mena-open-banking/vendors/<vendor>.md`
- `skills/mena-open-banking/references/integration-checklist.md` when implementation or launch readiness is requested
