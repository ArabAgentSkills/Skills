...
- `skills/mena-payments/sources.yml`
- `skills/mena-payments/vendors/<vendor>.md`
- `skills/mena-payments/references/integration-checklist.md` when implementation or launch readiness is requested
