...
- `skills/arabic-nlp/sources.yml`
- `skills/arabic-nlp/vendors/<vendor>.md`
- `skills/arabic-nlp/references/integration-checklist.md` when implementation or launch readiness is requested
