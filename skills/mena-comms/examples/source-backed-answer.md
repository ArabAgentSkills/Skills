...
- `skills/mena-comms/sources.yml`
- `skills/mena-comms/vendors/<vendor>.md`
- `skills/mena-comms/references/integration-checklist.md` when implementation or launch readiness is requested
