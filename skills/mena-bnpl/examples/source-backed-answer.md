...
- `skills/mena-bnpl/sources.yml`
- `skills/mena-bnpl/vendors/<vendor>.md`
- `skills/mena-bnpl/references/integration-checklist.md` when implementation or launch readiness is requested
