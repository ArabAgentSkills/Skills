---
name: arab-open-data
description: Use this skill when discovering or integrating Arab open-data APIs, CKAN/Socrata portals, SPARQL endpoints, government datasets, bulk downloads, and transparency sources across GCC, Levant, Egypt, and North Africa.
---
...
- Desired flow: identify, prefer, check, return.
...
3. If choosing vendors, compare only vendors in this skill's registry: bahrain-open-data-portal, morocco-open-data, oman-data-portal, qatar-open-data, qatar-open-data-api, saudi-open-data-portal, tunisia-open-data, uae-bayanat.
