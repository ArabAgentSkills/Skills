...
- `skills/arab-open-data/sources.yml`
- `skills/arab-open-data/vendors/<vendor>.md`
- `skills/arab-open-data/references/integration-checklist.md` when implementation or launch readiness is requested
