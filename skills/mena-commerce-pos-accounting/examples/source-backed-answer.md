...
- `skills/mena-commerce-pos-accounting/sources.yml`
- `skills/mena-commerce-pos-accounting/vendors/<vendor>.md`
- `skills/mena-commerce-pos-accounting/references/integration-checklist.md` when implementation or launch readiness is requested
