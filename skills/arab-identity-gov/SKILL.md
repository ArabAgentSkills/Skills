...
- Identify jurisdiction, identity assurance need, and whether access is public or partner-only.
- Read official government or provider source before advising.
- Separate public API discovery from onboarding and regulated access.
- Return privacy, consent, and credential handling checks.
