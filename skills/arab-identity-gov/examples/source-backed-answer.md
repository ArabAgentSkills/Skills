...
- `skills/arab-identity-gov/sources.yml`
- `skills/arab-identity-gov/vendors/<vendor>.md`
- `skills/arab-identity-gov/references/integration-checklist.md` when implementation or launch readiness is requested
