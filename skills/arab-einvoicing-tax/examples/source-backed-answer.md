...
- `skills/arab-einvoicing-tax/sources.yml`
- `skills/arab-einvoicing-tax/vendors/<vendor>.md`
- `skills/arab-einvoicing-tax/references/integration-checklist.md` when implementation or launch readiness is requested
