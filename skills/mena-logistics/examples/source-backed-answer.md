...
- `skills/mena-logistics/sources.yml`
- `skills/mena-logistics/vendors/<vendor>.md`
- `skills/mena-logistics/references/integration-checklist.md` when implementation or launch readiness is requested
